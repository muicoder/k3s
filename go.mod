...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.3.17-k26
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-io/kube-router/v2 v2.1.2
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.27-vip150360293
	...
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.26.7-k26
