...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.1-k26vip
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-vip/kube-router/v2 v2.6.3-vip
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.29-vip
	...
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.27.4-downgrade
	...
	github.com/kubernetes-sigs/cri-tools => github.com/k3s-vip/cri-tools v1.26.15-eol
	...
	github.com/rancher/wrangler => github.com/rancher/wrangler v1.1.1-0.20230831050635-df1bd5aae9df // v2.0.1
	...
	k8s.io/api => github.com/k3s-vip/kubernetes/staging/src/k8s.io/api v1.26.15-vip
	k8s.io/apiextensions-apiserver => github.com/k3s-vip/kubernetes/staging/src/k8s.io/apiextensions-apiserver v1.26.15-vip
	k8s.io/apimachinery => github.com/k3s-vip/kubernetes/staging/src/k8s.io/apimachinery v1.26.15-vip
	k8s.io/apiserver => github.com/k3s-vip/kubernetes/staging/src/k8s.io/apiserver v1.26.15-vip
	k8s.io/cli-runtime => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cli-runtime v1.26.15-vip
	k8s.io/client-go => github.com/k3s-vip/kubernetes/staging/src/k8s.io/client-go v1.26.15-vip
	k8s.io/cloud-provider => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cloud-provider v1.26.15-vip
	k8s.io/cluster-bootstrap => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cluster-bootstrap v1.26.15-vip
	k8s.io/code-generator => github.com/k3s-vip/kubernetes/staging/src/k8s.io/code-generator v1.26.15-vip
	k8s.io/component-base => github.com/k3s-vip/kubernetes/staging/src/k8s.io/component-base v1.26.15-vip
	k8s.io/component-helpers => github.com/k3s-vip/kubernetes/staging/src/k8s.io/component-helpers v1.26.15-vip
	k8s.io/controller-manager => github.com/k3s-vip/kubernetes/staging/src/k8s.io/controller-manager v1.26.15-vip
	k8s.io/cri-api => github.com/k3s-vip/kubernetes/staging/src/k8s.io/cri-api v1.26.15-vip
	k8s.io/csi-translation-lib => github.com/k3s-vip/kubernetes/staging/src/k8s.io/csi-translation-lib v1.26.15-vip
	k8s.io/dynamic-resource-allocation => github.com/k3s-vip/kubernetes/staging/src/k8s.io/dynamic-resource-allocation v1.26.15-vip
	k8s.io/klog/v2 => github.com/k3s-vip/klog/v2 latest // main
	k8s.io/kms => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kms v1.26.15-vip
	k8s.io/kube-aggregator => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-aggregator v1.26.15-vip
	k8s.io/kube-controller-manager => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-controller-manager v1.26.15-vip
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20230303024457-afdc3dddf62d
	k8s.io/kube-proxy => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-proxy v1.26.15-vip
	k8s.io/kube-scheduler => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kube-scheduler v1.26.15-vip
	k8s.io/kubectl => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kubectl v1.26.15-vip
	k8s.io/kubelet => github.com/k3s-vip/kubernetes/staging/src/k8s.io/kubelet v1.26.15-vip
	k8s.io/kubernetes => github.com/k3s-vip/kubernetes v1.26.15-vip
	k8s.io/legacy-cloud-providers => github.com/k3s-vip/kubernetes/staging/src/k8s.io/legacy-cloud-providers v1.26.15-vip
	k8s.io/metrics => github.com/k3s-vip/kubernetes/staging/src/k8s.io/metrics v1.26.15-vip
	k8s.io/mount-utils => github.com/k3s-vip/kubernetes/staging/src/k8s.io/mount-utils v1.26.15-vip
	k8s.io/node-api => github.com/k3s-vip/kubernetes/staging/src/k8s.io/node-api v1.26.15-vip
	k8s.io/pod-security-admission => github.com/k3s-vip/kubernetes/staging/src/k8s.io/pod-security-admission v1.26.15-vip
	k8s.io/sample-apiserver => github.com/k3s-vip/kubernetes/staging/src/k8s.io/sample-apiserver v1.26.15-vip
	k8s.io/sample-cli-plugin => github.com/k3s-vip/kubernetes/staging/src/k8s.io/sample-cli-plugin v1.26.15-vip
	k8s.io/sample-controller => github.com/k3s-vip/kubernetes/staging/src/k8s.io/sample-controller v1.26.15-vip
