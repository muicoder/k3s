...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.4.0-k29
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-io/kube-router/v2 v2.5.0
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.27-upward
	...
	github.com/rancher/dynamiclistener => github.com/k3s-vip/dynamiclistener v0.3.6-vip4263614
	github.com/rancher/wrangler => github.com/rancher/wrangler v1.1.1-0.20230818201331-3604a6be798d
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.3.0-vip0030164
