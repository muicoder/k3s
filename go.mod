...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.3.16-vip
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-io/kube-router/v2 v2.1.2
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.24-vip5
	...
	github.com/docker/docker => github.com/docker/docker v25.0.7+incompatible
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.26.2-vip
	...
	github.com/opencontainers/runc => github.com/k3s-vip/runc v1.2.3-vip
	...
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.0.28-vip
	go.etcd.io/etcd/api/v3 => github.com/k3s-vip/etcd/api/v3 v3.5.17-vip
	go.etcd.io/etcd/client/pkg/v3 => github.com/k3s-vip/etcd/client/pkg/v3 v3.5.17-vip
	go.etcd.io/etcd/client/v2 => github.com/k3s-vip/etcd/client/v2 v2.305.17-vip
	go.etcd.io/etcd/client/v3 => github.com/k3s-vip/etcd/client/v3 v3.5.17-vip
	go.etcd.io/etcd/etcdutl/v3 => github.com/k3s-vip/etcd/etcdutl/v3 v3.5.17-vip
	go.etcd.io/etcd/pkg/v3 => github.com/k3s-vip/etcd/pkg/v3 v3.5.17-vip
	go.etcd.io/etcd/raft/v3 => github.com/k3s-vip/etcd/raft/v3 v3.5.17-vip
	go.etcd.io/etcd/server/v3 => github.com/k3s-vip/etcd/server/v3 v3.5.17-vip
...
require (
	...
	github.com/k3s-io/helm-controller v0.15.15 // pkg/controllers/chart/chart.go
