...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-vip/cri-dockerd v0.3.16
	github.com/cloudnativelabs/kube-router/v2 => github.com/k3s-io/kube-router/v2 v2.1.2
	github.com/containerd/containerd => github.com/k3s-vip/containerd v1.7.25
	...
	github.com/flannel-io/flannel => github.com/k3s-vip/flannel v0.26.4
	...
	github.com/spegel-org/spegel => github.com/k3s-vip/spegel v0.0.30
